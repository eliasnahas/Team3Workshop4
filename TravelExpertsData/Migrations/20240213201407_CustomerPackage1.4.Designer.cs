...
namespace TravelExpertsData.Migrations
{
    ...
    [Migration("20240213201407_CustomerPackage1.4")]
    partial class CustomerPackage14
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerPackage", b =>
                {
                    ...
                    b.HasKey("CustomersCustomerId", "PackagesPackageId");
            ...
            modelBuilder.Entity("TravelExpertsData.PackagesProductsSupplier", b =>
                {
                    ...
                    b.HasKey("PackageProductSupplierId")
                        .HasName("PK__Packages__53E8ED99275927C7");
                    ...
                    b.HasIndex(new[] { "PackageId", "ProductSupplierId" }, "UQ__Packages__29CA8E9571D0E054")
                        .IsUnique();
            ...
            modelBuilder.Entity("CustomerPackage", b =>
                {
                    b.HasOne("TravelExpertsData.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomersCustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TravelExpertsData.Package", null)
                        .WithMany()
